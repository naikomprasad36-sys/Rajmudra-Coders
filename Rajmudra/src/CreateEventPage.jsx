...
export default function CreateEventPage({ onAddEvent }) {
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white p-8 rounded-3xl border border-slate-200 shadow-sm">
      ...
      <p className="text-xs text-slate-500 mb-6">Fill in details to publish an event on the portal.</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-indigo-600"
          />
        </div>
        ...
        <button
          type="submit"
          className="w-full mt-4 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl text-sm transition shadow"
        >
          Publish Event
        </button>
      </form>
