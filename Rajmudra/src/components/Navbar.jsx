  ...
  return (
    <>
      <header className="fixed top-0 inset-x-0 z-50 bg-gradient-to-b from-black/80 via-black/40 to-transparent backdrop-blur-md border-b border-white/10 transition-all duration-300">
          ...
          <div className="flex items-center gap-2.5">
            {user ? (
              ...
              <div className="flex items-center gap-2">
                {/* Log In Button (Sleek Transparent Outline) */}
                <button
                  onClick={() => handleOpenAuth('login')}
                  className="px-4 py-2 rounded-full text-xs font-bold text-white hover:text-[#E5B84B] hover:bg-white/15 border border-white/20 transition-all duration-300 flex items-center gap-1.5 backdrop-blur-md cursor-pointer"
                >
                ...
                <button
                  ...
                  className="relative group overflow-hidden px-4 sm:px-5 py-2 rounded-full bg-gradient-to-r from-[#D4A337] via-[#C59325] to-[#B8860B] hover:from-[#E5B84B] hover:to-[#D4A337] text-[#1A1614] font-black text-xs shadow-md shadow-[#D4A337]/30 hover:shadow-xl hover:shadow-[#D4A337]/40 hover:scale-105 active:scale-95 transition-all duration-300 flex items-center gap-1.5 border border-[#F3E5AB]/40 cursor-pointer"
                >
        ...
        <div className="md:hidden border-t border-white/10 px-4 py-2 bg-black/60 backdrop-blur-md overflow-x-auto flex items-center gap-1.5">
          {navItems.map((item) => {
            const Icon = item.icon;
            const isActive = activeTab === item.id;
            return (
