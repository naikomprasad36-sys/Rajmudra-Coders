...
export default function AdminEventsPanel({ events = [], setEvents, attendees = [] }) {
  ...
  return (
    <div className="space-y-8">
      {/* Header Banner */}
      <div className="bg-gradient-to-r from-slate-900 via-indigo-950 to-purple-950 text-white rounded-3xl p-8 shadow-xl relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-2">
            ...
            <h1 className="text-3xl sm:text-4xl font-black tracking-tight">Admin Events Control Center</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-5 rounded-3xl border border-slate-200 shadow-sm flex items-center gap-4">
          ...
          <div>
            <p className="text-xs font-semibold text-slate-500">Tickets Booked</p>
        ...
        <div className="bg-white p-5 rounded-3xl border border-slate-200 shadow-sm flex items-center gap-4">
          ...
          <div>
            <p className="text-xs font-semibold text-slate-500">Gate Attendees</p>
        ...
        <div className="bg-white p-5 rounded-3xl border border-slate-200 shadow-sm flex items-center gap-4">
          ...
          <div>
            <p className="text-xs font-semibold text-slate-500">Est. Revenue</p>
      ...
      <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
        <div className="p-5 border-b border-slate-100 flex items-center justify-between">
          <div>
            <h3 className="font-extrabold text-slate-900 text-base">Active Events Registry</h3>
